...
const HeroSection = () => {
  return (
    <div className="col-start-1 col-end-13 row-start-1 row-end-3 flex justify-center">
      ...
      {/* Banner_Container */}
      <div className="absolute mt-5 w-[80%] h-[15rem] md:h-[20rem] xl:h-[25rem] flex flex-col justify-evenly  items-center md:items-start md:mt-[8rem] 2xl:h-[35rem] 2xl:mt-[5rem] ">
        ...
        <div className="text-center md:text-left text-white 2xl:mt-10">
          <p className="w-[15em] md:w-[25rem] xl:w-[35rem] sm:text-lg md:text-xl xl:text-2xl md:font-light 2xl:text-4xl 2xl:w-[45rem]">
