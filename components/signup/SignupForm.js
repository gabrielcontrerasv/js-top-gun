...
export default function SignupForm() {
  ...
  return (
      ...
      <form class="w-full max-w-lg" onSubmit={handleSubmit(onSubmit)} style={{border: '2px solid red'}}>
        ...
        {/* <form>
                ...
                <button className="bg-[#154D4D] hover:bg-[#FEDB54] text-white hover:text-black font-bold py-3 px-6 rounded-full my-4" type="submit">Submit</button>
